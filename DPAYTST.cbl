      ...
      * Get the ACCOUNT DB2 copybook
       ...
       A010.
           ...
           WHEN 'C'
             ...
             MOVE WS-AVAIL-BAL    TO DFHCA-01-ACC-AVAIL-BAL-BEF
             MOVE WS-ACT-BAL      TO DFHCA-01-ACC-ACTUAL-BAL-BEF
             ...
             MOVE WS-AVAIL-BAL    TO DFHCA-01-ACC-AVAIL-BAL-AFT
             MOVE WS-ACT-BAL      TO DFHCA-01-ACC-ACTUAL-BAL-AFT
           ...
           WHEN 'B'
                 MOVE DFHCA-01-DEBIT-AC    TO  DFHCA-DEBIT-AC,
                                               DEBIT-AC
                 PERFORM GET-FUNDS-BALANCE
                 MOVE WS-AVAIL-BAL    TO DFHCA-01-ACC-AVAIL-BAL-AFT
                 MOVE WS-ACT-BAL      TO DFHCA-01-ACC-ACTUAL-BAL-AFT
           ...
           WHEN OTHER
                 MOVE  8  TO DFHCA-01-RETURN-CD
                 MOVE  'INVALID REQUEST, VALID VALUES - B,C'
                          TO DFHCA-01-ERROR-MSG
           END-EVALUATE.
      ...
      *     MOVE '98765400000001'  TO  DFHCA-CREDIT-AC.
           MOVE DFHCA-01-CONSENT-REQ TO  DFHCA-CONSENT-REQ.
      ...
      *     MOVE 50                TO  DFHCA-CONSENT-AMOUNT.
           ...
           MOVE DFHCA-01-CREDIT-AC   TO  DFHCA-CREDIT-AC.
           MOVE DFHCA-01-DEBIT-AC    TO  DFHCA-DEBIT-AC,
                                         DEBIT-AC.
           MOVE DFHCA-01-CONSENT-AMOUNT  TO  DFHCA-CONSENT-AMOUNT.
           PERFORM TEST-CALL.
       ...
       TC010.
           ...
           IF WS-PGM-NAME = 'DPAYAPI'
             DISPLAY 'DFHCA-CONSENT-ID           :',
                                         DFHCA-CONSENT-ID
             MOVE DFHCA-CONSENT-ID TO DFHCA-01-CONSENT-ID

             DISPLAY 'DFHCA-CONSENT-STATUS       :',
                                         DFHCA-CONSENT-STATUS
             MOVE DFHCA-CONSENT-STATUS TO DFHCA-01-CONSENT-STATUS

             DISPLAY 'DFHCA-DOMESTIC-PAY-ID      :',
                                         DFHCA-DOMESTIC-PAY-ID
             MOVE DFHCA-DOMESTIC-PAY-ID TO DFHCA-01-DOMESTIC-PAY-ID

             DISPLAY 'DFHCA-DOMESTIC-PAY-STATUS  :',
                                         DFHCA-DOMESTIC-PAY-STATUS
             MOVE DFHCA-DOMESTIC-PAY-STATUS TO
                                         DFHCA-01-DOMESTIC-PAY-STATUS
             DISPLAY 'DFHCA-DEBIT-AC             :',
                                         DFHCA-DEBIT-AC
             MOVE DFHCA-DEBIT-AC TO DFHCA-01-DEBIT-AC

             DISPLAY 'DFHCA-DEBIT-AC-CUSTNAME    :',
                                         DFHCA-DEBIT-AC-CUSTNAME
             MOVE DFHCA-DEBIT-AC-CUSTNAME TO DFHCA-01-DEBIT-AC-CUSTNAME

             DISPLAY 'DFHCA-CREDIT-AC            :',
                                         DFHCA-CREDIT-AC
             MOVE DFHCA-CREDIT-AC TO DFHCA-01-CREDIT-AC

             DISPLAY 'DFHCA-CREDIT-AC-CUSTNAME   :',
                                         DFHCA-CREDIT-AC-CUSTNAME
             MOVE DFHCA-CREDIT-AC-CUSTNAME TO
                                         DFHCA-01-CREDIT-AC-CUSTNAME
             MOVE DFHCA-CONSENT-AMOUNT TO WS-PAY-AMT
             MOVE DFHCA-CONSENT-AMOUNT TO DFHCA-01-CONSENT-AMOUNT
             DISPLAY 'DFHCA-CONSENT-AMOUNT       :',
                                         WS-PAY-AMT
             DISPLAY 'DFHCA-CURRENCY-CD          :',
                                         DFHCA-CURRENCY-CD
             MOVE DFHCA-CURRENCY-CD TO DFHCA-01-CURRENCY-CD
             MOVE DFHCA-RETURN-CD        TO WS-ERR-RET-CD
             MOVE DFHCA-RETURN-CD TO DFHCA-01-RETURN-CD
